...
(function() {
    ...
    const translations = {
        en: {
            ...
            'who-we-are.highlight1.title': 'Innovation-Driven',
            'who-we-are.highlight1.description': 'Cutting-edge AI solutions that transform businesses',
            'who-we-are.highlight2.title': 'Regional Impact',
            'who-we-are.highlight2.description': 'Strengthening Latin America\'s digital ecosystem',
            'who-we-are.highlight3.title': 'Human-Centered',
            'who-we-are.highlight3.description': 'Technology designed for people and their needs',
            'who-we-are.team-title': 'Our Team',
            'who-we-are.team-description': 'Behind Atomic AI there is a small, focused team that combines <strong>deep technical expertise</strong> with strong experience in <strong>education, economics, and public policy</strong>. We work at the intersection of <strong>artificial intelligence, data engineering, and real-world impact</strong> in Latin America and beyond.',
            'who-we-are.team-button': 'Meet Our Team',
            'who-we-are.stat.experts': '3',
            'who-we-are.stat.experts-label': 'Expert Professionals',
            'who-we-are.stat.countries': '4+',
            'who-we-are.stat.countries-label': 'Countries',
            ...
            'vision.description': 'To become a regional leader in custom AI development—recognized for transforming organizations through reliable, scalable, and meaningful innovation with real-world impact.',
        ...
        es: {
            ...
            'who-we-are.highlight1.title': 'Impulsados por la Innovación',
            'who-we-are.highlight1.description': 'Soluciones de IA de vanguardia que transforman negocios',
            'who-we-are.highlight2.title': 'Impacto Regional',
            'who-we-are.highlight2.description': 'Fortalecimiento del ecosistema digital de América Latina',
            'who-we-are.highlight3.title': 'Centrados en las Personas',
            'who-we-are.highlight3.description': 'Tecnología diseñada para personas y sus necesidades',
            'who-we-are.team-title': 'Nuestro Equipo',
            'who-we-are.team-description': 'Detrás de Atomic AI hay un equipo pequeño y enfocado que combina <strong>experiencia técnica profunda</strong> con sólida experiencia en <strong>educación, economía y políticas públicas</strong>. Trabajamos en la intersección de <strong>inteligencia artificial, ingeniería de datos e impacto en el mundo real</strong> en América Latina y más allá.',
            'who-we-are.team-button': 'Conoce a Nuestro Equipo',
            'who-we-are.stat.experts': '3',
            'who-we-are.stat.experts-label': 'Profesionales Expertos',
            'who-we-are.stat.countries': '4+',
            'who-we-are.stat.countries-label': 'Países',
            ...
            'vision.description': 'Convertirnos en líder regional en desarrollo de IA personalizada—reconocidos por transformar organizaciones a través de innovación confiable, escalable y significativa con impacto en el mundo real.',
            ...
            'objectives.ecosystem.description': 'Contribuir al desarrollo tecnológico en la región a través de innovación, educación y asociaciones de alto valor.',
            ...
            'projects.page.description': 'Explora nuestras soluciones innovadoras de IA que están transformando negocios en Centroamérica. Cada proyecto representa nuestro compromiso de entregar tecnología de vanguardia con impacto real.',
        ...
        fr: {
            ...
            'who-we-are.highlight1.title': 'Axé sur l\'Innovation',
            'who-we-are.highlight1.description': 'Solutions IA de pointe qui transforment les entreprises',
            'who-we-are.highlight2.title': 'Impact Régional',
            'who-we-are.highlight2.description': 'Renforcement de l\'écosystème numérique de l\'Amérique latine',
            'who-we-are.highlight3.title': 'Centré sur l\'Humain',
            'who-we-are.highlight3.description': 'Technologie conçue pour les personnes et leurs besoins',
            'who-we-are.team-title': 'Notre Équipe',
            'who-we-are.team-description': 'Derrière Atomic AI se trouve une équipe petite et ciblée qui combine une <strong>expertise technique approfondie</strong> avec une solide expérience en <strong>éducation, économie et politiques publiques</strong>. Nous travaillons à l\'intersection de <strong>l\'intelligence artificielle, de l\'ingénierie des données et de l\'impact réel</strong> en Amérique latine et au-delà.',
            'who-we-are.team-button': 'Rencontrer Notre Équipe',
            'who-we-are.stat.experts': '3',
            'who-we-are.stat.experts-label': 'Professionnels Experts',
            'who-we-are.stat.countries': '4+',
            'who-we-are.stat.countries-label': 'Pays',
            ...
            'vision.description': 'Devenir un leader régional dans le développement d\'IA personnalisée—reconnu pour transformer les organisations grâce à une innovation fiable, évolutive et significative avec un impact réel.',
            ...
            'objectives.ecosystem.description': 'Contribuer au développement technologique dans la région grâce à l\'innovation, l\'éducation et des partenariats à haute valeur ajoutée.',
            ...
            'projects.page.description': 'Explorez nos solutions innovantes d\'IA qui transforment les entreprises en Amérique centrale. Chaque projet représente notre engagement à fournir une technologie de pointe avec un impact réel.',
